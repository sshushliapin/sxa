...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.sxa.localhost/ --auth https://id.sxa.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
  dotnet sitecore login --cm https://cm.sxa.localhost/ --auth https://id.sxa.localhost/ --allow-write true
}
...
Start-Process https://cm.sxa.localhost/sitecore/
Start-Process https://www.sxa.localhost/
