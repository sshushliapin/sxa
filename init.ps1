...
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.sxa.localhost"
}
Add-HostsEntry "cm.sxa.localhost"
Add-HostsEntry "id.sxa.localhost"
Add-HostsEntry "www.sxa.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.sxa.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.sxa.localhost"
    }


    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.sxa.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.sxa.localhost"
